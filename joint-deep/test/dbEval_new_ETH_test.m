...
for id=ids
  switch id
    ...
    case 15,   alg = def('DBN-Isol', 0, id);
    case 16,   alg = def('DBN-Mut', 0, id);
    case 17,   alg = def('FisherBoost', 0, id);
    case 18,   alg = def('Franken', 0, id);
    case 19,   alg = def('HOG', 0, id);
    case 20,   alg = def('JointDeep', 0, id);
    case 21,   alg = def('LDCF', 0, id);
    case 22,   alg = def('MF+Motion+2Ped', 0, id);
    case 23,   alg = def('MultiSDP', 0, id);
    case 24,   alg = def('RandForest', 0, id);
    case 25,   alg = def('Roerei', 0, id);
    case 26,   alg = def('SDN', 0, id);
    case 27,   alg = def('SpatialPooling', 0, id);
    case 28,   alg = def('TA-CNN', 0, id);
    case 29,   alg = def('VJ', 0, id);
